...
const AboutSection = () => {
  ...
  useEffect(() => {
    if (portfolioData) {
      SetTabData((pre) => {
        for (const el of pre) {
          if (el.id === 'skills') el.content = portfolioData.skills;
          if (el.id === 'education') el.content = portfolioData.education;
    ...
    <section className="text-white" id="about">
      <div className="md:grid md:grid-cols-2 gap-8  py-8 px-4 xl:gasp-16 sm:p-10 items-center">
        ...
        <div className="mt-4 md:mt-0">
          ...
          <p className="text-base md:text-lg">{portfolioData.aboutme}</p>
